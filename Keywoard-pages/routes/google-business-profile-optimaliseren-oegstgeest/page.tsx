...
const pageContent = {
  ...
  "sourceTitle": "Google Business Profile optimaliseren in Oegstgeest: checklist voor lokale bedrijven",
  "sourceKeyword": "Google Business Profile optimaliseren Oegstgeest",
  "slug": "google-business-profile-optimaliseren-oegstgeest",
  "productionPath": "/inzichten/google-business-profile-optimaliseren-oegstgeest",
  "metaTitle": "Google Business Profile optimaliseren in Oegstgeest",
  "metaDescription": "Praktische checklist om je Google Business Profile in Oegstgeest consistenter, vollediger en beter verbonden met je website te maken.",
  "eyebrow": "Google Business Profile",
  "title": "Google Business Profile optimaliseren in Oegstgeest: checklist voor lokale bedrijven",
  ...
  "directAnswer": "Je Google Business Profile optimaliseren in Oegstgeest begint met complete categorieen, diensten, openingstijden, foto's, reviews en consistente contactgegevens. Je website moet dezelfde diensten en regio bevestigen.",
  "visual": {
    "label": "Profielcheck",
  ...
  "sections": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "text": "Gebruik alleen informatie die klopt voor Oegstgeest en omgeving."
        }
      ]
    },
    {
  ...
  "checklistTitle": "Google Business Profile checklist voor Oegstgeest",
  "checklist": [
  ...
  "schemaType": "Article",
  "draftPath": "/Keywoard-pages/routes/google-business-profile-optimaliseren-oegstgeest/page.tsx",
