...
export const landingPages: LandingPage[] = [
  ...
  }),
  {
    ...
    heroPoints: ["Alleen noodzakelijke gegevens", "Geen verkoop van persoonsgegevens", "Vragen via hallo@magisdata.nl"],
    sections: [
      {
    ...
    faqs: [
      ...
      { question: "Kan ik mijn gegevens laten verwijderen?", answer: "Ja. Mail naar hallo@magisdata.nl." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "Kan ik extra informatie sturen?", answer: "Ja. Mail gerust naar hallo@magisdata.nl." }
    ]
  }
];
