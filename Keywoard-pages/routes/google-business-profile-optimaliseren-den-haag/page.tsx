...
const pageContent = {
  ...
  "sourceTitle": "Google Business Profile optimaliseren in Den Haag: checklist voor lokale bedrijven",
  "sourceKeyword": "Google Business Profile optimaliseren Den Haag",
  "slug": "google-business-profile-optimaliseren-den-haag",
  "productionPath": "/inzichten/google-business-profile-optimaliseren-den-haag",
  "metaTitle": "Google Business Profile optimaliseren in Den Haag",
  "metaDescription": "Praktische checklist om je Google Business Profile in Den Haag consistenter, vollediger en beter verbonden met je website te maken.",
  "eyebrow": "Google Business Profile",
  "title": "Google Business Profile optimaliseren in Den Haag: checklist voor lokale bedrijven",
  ...
  "directAnswer": "Je Google Business Profile optimaliseren in Den Haag begint met complete categorieen, diensten, openingstijden, foto's, reviews en consistente contactgegevens. Je website moet dezelfde diensten en regio bevestigen.",
  "visual": {
    "label": "Profielcheck",
  ...
  "sections": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "text": "Gebruik alleen informatie die klopt voor Den Haag en omgeving."
        }
      ]
    },
    {
  ...
  "checklistTitle": "Google Business Profile checklist voor Den Haag",
  "checklist": [
  ...
  "schemaType": "Article",
  "draftPath": "/Keywoard-pages/routes/google-business-profile-optimaliseren-den-haag/page.tsx",
