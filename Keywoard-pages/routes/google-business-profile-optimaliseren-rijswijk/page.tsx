...
const pageContent = {
  ...
  "sourceTitle": "Google Business Profile optimaliseren in Rijswijk: checklist voor lokale bedrijven",
  "sourceKeyword": "Google Business Profile optimaliseren Rijswijk",
  "slug": "google-business-profile-optimaliseren-rijswijk",
  "productionPath": "/inzichten/google-business-profile-optimaliseren-rijswijk",
  "metaTitle": "Google Business Profile optimaliseren in Rijswijk",
  "metaDescription": "Praktische checklist om je Google Business Profile in Rijswijk consistenter, vollediger en beter verbonden met je website te maken.",
  "eyebrow": "Google Business Profile",
  "title": "Google Business Profile optimaliseren in Rijswijk: checklist voor lokale bedrijven",
  ...
  "directAnswer": "Je Google Business Profile optimaliseren in Rijswijk begint met complete categorieen, diensten, openingstijden, foto's, reviews en consistente contactgegevens. Je website moet dezelfde diensten en regio bevestigen.",
  "visual": {
    "label": "Profielcheck",
  ...
  "sections": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "text": "Gebruik alleen informatie die klopt voor Rijswijk en omgeving."
        }
      ]
    },
    {
  ...
  "checklistTitle": "Google Business Profile checklist voor Rijswijk",
  "checklist": [
  ...
  "schemaType": "Article",
  "draftPath": "/Keywoard-pages/routes/google-business-profile-optimaliseren-rijswijk/page.tsx",
