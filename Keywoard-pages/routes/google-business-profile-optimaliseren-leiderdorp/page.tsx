...
const pageContent = {
  ...
  "sourceTitle": "Google Business Profile optimaliseren in Leiderdorp: checklist voor lokale bedrijven",
  "sourceKeyword": "Google Business Profile optimaliseren Leiderdorp",
  "slug": "google-business-profile-optimaliseren-leiderdorp",
  "productionPath": "/inzichten/google-business-profile-optimaliseren-leiderdorp",
  "metaTitle": "Google Business Profile optimaliseren in Leiderdorp",
  "metaDescription": "Praktische checklist om je Google Business Profile in Leiderdorp consistenter, vollediger en beter verbonden met je website te maken.",
  "eyebrow": "Google Business Profile",
  "title": "Google Business Profile optimaliseren in Leiderdorp: checklist voor lokale bedrijven",
  ...
  "directAnswer": "Je Google Business Profile optimaliseren in Leiderdorp begint met complete categorieen, diensten, openingstijden, foto's, reviews en consistente contactgegevens. Je website moet dezelfde diensten en regio bevestigen.",
  "visual": {
    "label": "Profielcheck",
  ...
  "sections": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "text": "Gebruik alleen informatie die klopt voor Leiderdorp en omgeving."
        }
      ]
    },
    {
  ...
  "checklistTitle": "Google Business Profile checklist voor Leiderdorp",
  "checklist": [
  ...
  "schemaType": "Article",
  "draftPath": "/Keywoard-pages/routes/google-business-profile-optimaliseren-leiderdorp/page.tsx",
