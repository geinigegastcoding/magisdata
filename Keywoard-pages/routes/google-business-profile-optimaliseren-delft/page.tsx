...
const pageContent = {
  ...
  "sourceTitle": "Google Business Profile optimaliseren in Delft: checklist voor lokale bedrijven",
  "sourceKeyword": "Google Business Profile optimaliseren Delft",
  "slug": "google-business-profile-optimaliseren-delft",
  "productionPath": "/inzichten/google-business-profile-optimaliseren-delft",
  "metaTitle": "Google Business Profile optimaliseren in Delft",
  "metaDescription": "Praktische checklist om je Google Business Profile in Delft consistenter, vollediger en beter verbonden met je website te maken.",
  "eyebrow": "Google Business Profile",
  "title": "Google Business Profile optimaliseren in Delft: checklist voor lokale bedrijven",
  ...
  "directAnswer": "Je Google Business Profile optimaliseren in Delft begint met complete categorieen, diensten, openingstijden, foto's, reviews en consistente contactgegevens. Je website moet dezelfde diensten en regio bevestigen.",
  "visual": {
    "label": "Profielcheck",
  ...
  "sections": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "text": "Gebruik alleen informatie die klopt voor Delft en omgeving."
        }
      ]
    },
    {
  ...
  "checklistTitle": "Google Business Profile checklist voor Delft",
  "checklist": [
  ...
  "schemaType": "Article",
  "draftPath": "/Keywoard-pages/routes/google-business-profile-optimaliseren-delft/page.tsx",
