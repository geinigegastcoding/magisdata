...
const pageContent = {
  ...
  "sourceTitle": "Google Business Profile optimaliseren in Leidschendam: checklist voor lokale bedrijven",
  "sourceKeyword": "Google Business Profile optimaliseren Leidschendam",
  "slug": "google-business-profile-optimaliseren-leidschendam",
  "productionPath": "/inzichten/google-business-profile-optimaliseren-leidschendam",
  "metaTitle": "Google Business Profile optimaliseren in Leidschendam",
  "metaDescription": "Praktische checklist om je Google Business Profile in Leidschendam consistenter, vollediger en beter verbonden met je website te maken.",
  "eyebrow": "Google Business Profile",
  "title": "Google Business Profile optimaliseren in Leidschendam: checklist voor lokale bedrijven",
  ...
  "directAnswer": "Je Google Business Profile optimaliseren in Leidschendam begint met complete categorieen, diensten, openingstijden, foto's, reviews en consistente contactgegevens. Je website moet dezelfde diensten en regio bevestigen.",
  "visual": {
    "label": "Profielcheck",
  ...
  "sections": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "text": "Gebruik alleen informatie die klopt voor Leidschendam en omgeving."
        }
      ]
    },
    {
  ...
  "checklistTitle": "Google Business Profile checklist voor Leidschendam",
  "checklist": [
  ...
  "schemaType": "Article",
  "draftPath": "/Keywoard-pages/routes/google-business-profile-optimaliseren-leidschendam/page.tsx",
