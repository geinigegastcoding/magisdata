...
const pageContent = {
  ...
  "sourceTitle": "Google Business Profile optimaliseren in Voorburg: checklist voor lokale bedrijven",
  "sourceKeyword": "Google Business Profile optimaliseren Voorburg",
  "slug": "google-business-profile-optimaliseren-voorburg",
  "productionPath": "/inzichten/google-business-profile-optimaliseren-voorburg",
  "metaTitle": "Google Business Profile optimaliseren in Voorburg",
  "metaDescription": "Praktische checklist om je Google Business Profile in Voorburg consistenter, vollediger en beter verbonden met je website te maken.",
  "eyebrow": "Google Business Profile",
  "title": "Google Business Profile optimaliseren in Voorburg: checklist voor lokale bedrijven",
  ...
  "directAnswer": "Je Google Business Profile optimaliseren in Voorburg begint met complete categorieen, diensten, openingstijden, foto's, reviews en consistente contactgegevens. Je website moet dezelfde diensten en regio bevestigen.",
  "visual": {
    "label": "Profielcheck",
  ...
  "sections": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "text": "Gebruik alleen informatie die klopt voor Voorburg en omgeving."
        }
      ]
    },
    {
  ...
  "checklistTitle": "Google Business Profile checklist voor Voorburg",
  "checklist": [
  ...
  "schemaType": "Article",
  "draftPath": "/Keywoard-pages/routes/google-business-profile-optimaliseren-voorburg/page.tsx",
