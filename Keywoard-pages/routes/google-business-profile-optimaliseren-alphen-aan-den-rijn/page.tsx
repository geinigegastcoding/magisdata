...
const pageContent = {
  ...
  "sourceTitle": "Google Business Profile optimaliseren in Alphen aan den Rijn: checklist voor lokale bedrijven",
  "sourceKeyword": "Google Business Profile optimaliseren Alphen aan den Rijn",
  "slug": "google-business-profile-optimaliseren-alphen-aan-den-rijn",
  "productionPath": "/inzichten/google-business-profile-optimaliseren-alphen-aan-den-rijn",
  "metaTitle": "Google Business Profile optimaliseren in Alphen aan den Rijn",
  "metaDescription": "Praktische checklist om je Google Business Profile in Alphen aan den Rijn consistenter, vollediger en beter verbonden met je website te maken.",
  "eyebrow": "Google Business Profile",
  "title": "Google Business Profile optimaliseren in Alphen aan den Rijn: checklist voor lokale bedrijven",
  ...
  "directAnswer": "Je Google Business Profile optimaliseren in Alphen aan den Rijn begint met complete categorieen, diensten, openingstijden, foto's, reviews en consistente contactgegevens. Je website moet dezelfde diensten en regio bevestigen.",
  "visual": {
    "label": "Profielcheck",
  ...
  "sections": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "text": "Gebruik alleen informatie die klopt voor Alphen aan den Rijn en omgeving."
        }
      ]
    },
    {
  ...
  "checklistTitle": "Google Business Profile checklist voor Alphen aan den Rijn",
  "checklist": [
  ...
  "schemaType": "Article",
  "draftPath": "/Keywoard-pages/routes/google-business-profile-optimaliseren-alphen-aan-den-rijn/page.tsx",
