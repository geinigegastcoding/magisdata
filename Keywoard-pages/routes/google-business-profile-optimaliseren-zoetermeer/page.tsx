...
const pageContent = {
  ...
  "sourceTitle": "Google Business Profile optimaliseren in Zoetermeer: checklist voor lokale bedrijven",
  "sourceKeyword": "Google Business Profile optimaliseren Zoetermeer",
  "slug": "google-business-profile-optimaliseren-zoetermeer",
  "productionPath": "/inzichten/google-business-profile-optimaliseren-zoetermeer",
  "metaTitle": "Google Business Profile optimaliseren in Zoetermeer",
  "metaDescription": "Praktische checklist om je Google Business Profile in Zoetermeer consistenter, vollediger en beter verbonden met je website te maken.",
  "eyebrow": "Google Business Profile",
  "title": "Google Business Profile optimaliseren in Zoetermeer: checklist voor lokale bedrijven",
  ...
  "directAnswer": "Je Google Business Profile optimaliseren in Zoetermeer begint met complete categorieen, diensten, openingstijden, foto's, reviews en consistente contactgegevens. Je website moet dezelfde diensten en regio bevestigen.",
  "visual": {
    "label": "Profielcheck",
  ...
  "sections": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "text": "Gebruik alleen informatie die klopt voor Zoetermeer en omgeving."
        }
      ]
    },
    {
  ...
  "checklistTitle": "Google Business Profile checklist voor Zoetermeer",
  "checklist": [
  ...
  "schemaType": "Article",
  "draftPath": "/Keywoard-pages/routes/google-business-profile-optimaliseren-zoetermeer/page.tsx",
