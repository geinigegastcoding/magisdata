...
const pageContent = {
  ...
  "sourceTitle": "Google Business Profile optimaliseren in Leiden: checklist voor lokale bedrijven",
  "sourceKeyword": "Google Business Profile optimaliseren Leiden",
  "slug": "google-business-profile-optimaliseren-leiden",
  "productionPath": "/inzichten/google-business-profile-optimaliseren-leiden",
  "metaTitle": "Google Business Profile optimaliseren in Leiden",
  "metaDescription": "Praktische checklist om je Google Business Profile in Leiden consistenter, vollediger en beter verbonden met je website te maken.",
  "eyebrow": "Google Business Profile",
  "title": "Google Business Profile optimaliseren in Leiden: checklist voor lokale bedrijven",
  ...
  "directAnswer": "Je Google Business Profile optimaliseren in Leiden begint met complete categorieen, diensten, openingstijden, foto's, reviews en consistente contactgegevens. Je website moet dezelfde diensten en regio bevestigen.",
  "visual": {
    "label": "Profielcheck",
  ...
  "sections": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "text": "Gebruik alleen informatie die klopt voor Leiden en omgeving."
        }
      ]
    },
    {
  ...
  "checklistTitle": "Google Business Profile checklist voor Leiden",
  "checklist": [
  ...
  "schemaType": "Article",
  "draftPath": "/Keywoard-pages/routes/google-business-profile-optimaliseren-leiden/page.tsx",
