...
const pageContent = {
  ...
  "sourceTitle": "Google Business Profile optimaliseren in Wassenaar: checklist voor lokale bedrijven",
  "sourceKeyword": "Google Business Profile optimaliseren Wassenaar",
  "slug": "google-business-profile-optimaliseren-wassenaar",
  "productionPath": "/inzichten/google-business-profile-optimaliseren-wassenaar",
  "metaTitle": "Google Business Profile optimaliseren in Wassenaar",
  "metaDescription": "Praktische checklist om je Google Business Profile in Wassenaar consistenter, vollediger en beter verbonden met je website te maken.",
  "eyebrow": "Google Business Profile",
  "title": "Google Business Profile optimaliseren in Wassenaar: checklist voor lokale bedrijven",
  ...
  "directAnswer": "Je Google Business Profile optimaliseren in Wassenaar begint met complete categorieen, diensten, openingstijden, foto's, reviews en consistente contactgegevens. Je website moet dezelfde diensten en regio bevestigen.",
  "visual": {
    "label": "Profielcheck",
  ...
  "sections": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "text": "Gebruik alleen informatie die klopt voor Wassenaar en omgeving."
        }
      ]
    },
    {
  ...
  "checklistTitle": "Google Business Profile checklist voor Wassenaar",
  "checklist": [
  ...
  "schemaType": "Article",
  "draftPath": "/Keywoard-pages/routes/google-business-profile-optimaliseren-wassenaar/page.tsx",
