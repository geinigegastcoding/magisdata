...
const pageContent = {
  ...
  "sourceTitle": "Google Business Profile optimaliseren in Katwijk: checklist voor lokale bedrijven",
  "sourceKeyword": "Google Business Profile optimaliseren Katwijk",
  "slug": "google-business-profile-optimaliseren-katwijk",
  "productionPath": "/inzichten/google-business-profile-optimaliseren-katwijk",
  "metaTitle": "Google Business Profile optimaliseren in Katwijk",
  "metaDescription": "Praktische checklist om je Google Business Profile in Katwijk consistenter, vollediger en beter verbonden met je website te maken.",
  "eyebrow": "Google Business Profile",
  "title": "Google Business Profile optimaliseren in Katwijk: checklist voor lokale bedrijven",
  ...
  "directAnswer": "Je Google Business Profile optimaliseren in Katwijk begint met complete categorieen, diensten, openingstijden, foto's, reviews en consistente contactgegevens. Je website moet dezelfde diensten en regio bevestigen.",
  "visual": {
    "label": "Profielcheck",
  ...
  "sections": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "text": "Gebruik alleen informatie die klopt voor Katwijk en omgeving."
        }
      ]
    },
    {
  ...
  "checklistTitle": "Google Business Profile checklist voor Katwijk",
  "checklist": [
  ...
  "schemaType": "Article",
  "draftPath": "/Keywoard-pages/routes/google-business-profile-optimaliseren-katwijk/page.tsx",
