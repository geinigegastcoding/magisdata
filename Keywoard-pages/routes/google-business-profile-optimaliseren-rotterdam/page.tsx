...
const pageContent = {
  ...
  "sourceTitle": "Google Business Profile optimaliseren in Rotterdam: checklist voor lokale bedrijven",
  "sourceKeyword": "Google Business Profile optimaliseren Rotterdam",
  "slug": "google-business-profile-optimaliseren-rotterdam",
  "productionPath": "/inzichten/google-business-profile-optimaliseren-rotterdam",
  "metaTitle": "Google Business Profile optimaliseren in Rotterdam",
  "metaDescription": "Praktische checklist om je Google Business Profile in Rotterdam consistenter, vollediger en beter verbonden met je website te maken.",
  "eyebrow": "Google Business Profile",
  "title": "Google Business Profile optimaliseren in Rotterdam: checklist voor lokale bedrijven",
  ...
  "directAnswer": "Je Google Business Profile optimaliseren in Rotterdam begint met complete categorieen, diensten, openingstijden, foto's, reviews en consistente contactgegevens. Je website moet dezelfde diensten en regio bevestigen.",
  "visual": {
    "label": "Profielcheck",
  ...
  "sections": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "text": "Gebruik alleen informatie die klopt voor Rotterdam en omgeving."
        }
      ]
    },
    {
  ...
  "checklistTitle": "Google Business Profile checklist voor Rotterdam",
  "checklist": [
  ...
  "schemaType": "Article",
  "draftPath": "/Keywoard-pages/routes/google-business-profile-optimaliseren-rotterdam/page.tsx",
