...
const pageContent = {
  ...
  "sourceTitle": "Google Business Profile optimaliseren in Noordwijk: checklist voor lokale bedrijven",
  "sourceKeyword": "Google Business Profile optimaliseren Noordwijk",
  "slug": "google-business-profile-optimaliseren-noordwijk",
  "productionPath": "/inzichten/google-business-profile-optimaliseren-noordwijk",
  "metaTitle": "Google Business Profile optimaliseren in Noordwijk",
  "metaDescription": "Praktische checklist om je Google Business Profile in Noordwijk consistenter, vollediger en beter verbonden met je website te maken.",
  "eyebrow": "Google Business Profile",
  "title": "Google Business Profile optimaliseren in Noordwijk: checklist voor lokale bedrijven",
  ...
  "directAnswer": "Je Google Business Profile optimaliseren in Noordwijk begint met complete categorieen, diensten, openingstijden, foto's, reviews en consistente contactgegevens. Je website moet dezelfde diensten en regio bevestigen.",
  "visual": {
    "label": "Profielcheck",
  ...
  "sections": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "text": "Gebruik alleen informatie die klopt voor Noordwijk en omgeving."
        }
      ]
    },
    {
  ...
  "checklistTitle": "Google Business Profile checklist voor Noordwijk",
  "checklist": [
  ...
  "schemaType": "Article",
  "draftPath": "/Keywoard-pages/routes/google-business-profile-optimaliseren-noordwijk/page.tsx",
